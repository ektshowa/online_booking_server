...
class EmailParser {
	...
	#
	##################################################################################
	static function is_valid_email_address($email, $options=array()){
		#
		...
		if ($options['allow_comments']){
			$email = EmailParser::email_strip_comments($outer_comment, $email, "(x)");
		}
		#
	...
	##################################################################################
	static function email_strip_comments($comment, $email, $replace=''){
		while (1){
